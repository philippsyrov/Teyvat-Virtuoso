...
app_root="$project_root/build/Genshin Lyre Player.app"
...
swiftc "$project_root/player/GenshinLyrePlayerApp.swift" -o "$app_root/Contents/MacOS/GenshinLyrePlayer" -framework AppKit -framework CoreGraphics
